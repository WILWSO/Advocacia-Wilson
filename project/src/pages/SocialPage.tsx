...
import { usePostsSociais } from '../hooks/useSupabase';
      ...
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
        ...
        <div className="p-4 sm:p-6 border-b border-neutral-200 flex items-center justify-between">
          <h2 className="text-lg sm:text-xl font-semibold text-neutral-800">
              {editingPost ? 'Editar Conteúdo' : 'Criar Novo Conteúdo'}
            </h2>
            <button
              type="button"
              onClick={onClose}
              className="ml-4 p-2 rounded-full hover:bg-neutral-100 focus:outline-none focus:ring-2 focus:ring-primary-500"
