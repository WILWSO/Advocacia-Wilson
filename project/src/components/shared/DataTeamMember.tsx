export const teamMemberData = [
  { //Em uma aplicação real, esse dados devem vim do banco de dados.
    ...
    specialties: ['Direito Empresarial', 'Direito Tributário', 'Direito Civil', 'Direito de Família',
     'Direito do Trabalho', 'Direito Contratual'],
  ...
  },
  {
    ...
    specialties: ['Direito Civil', 'Direito Imobiliário','Direito Tributário', 'Direito Empresarial'],
  ...
  },
  {
    ...
    specialties: ['Direito Trabalhista', 'Direito eleitoral'],
